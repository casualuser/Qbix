...
/**
 * Used by HTTP clients to upload a new audio to the server
 * @class Q/audio
 * @method post
 ...
 *   @param {string} [$params.name] override the name of the audio, after the subpath
 */
function Q_audio_post($params = null)
{
    $p = $params
        ? $params
